  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center m-10">
        ...
        justify-center mb-6">
        <Label
        className={`bg-slate-800 p-2 px-16 rounded-l-lg cursor-pointer ${selectedOption === 'option1' ? 'font-semibold bg-slate-700' : ''}`}
        onClick={() => setSelectedOption('option1')}>
            OPÇÃO 1
        </Label>
        <Label
        className={`bg-slate-800 p-2 px-16 rounded-r-lg cursor-pointer ${selectedOption === 'option2' ? 'font-semibold bg-slate-700' : ''}`}
